...
public class ArchivePage extends BasePage {
    ...
    @FindBy(xpath = "//span[contains(text(),'Archivieren')]")
    private WebElement mainArchiveItemButton;
    ...
    public void archiveReasonInputField(String reason) {
    ...
    public void clickMainArchiveButton() {
        getWait().forVisibility(mainArchiveItemButton);
        mainArchiveItemButton.click();
    }
